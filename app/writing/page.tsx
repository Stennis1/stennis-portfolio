...
export default function WritingPage() {
  const articles = [
    ...
    },
    {
      ...
      description:
        "The Battle of New Year Resolutions... \n\ \
    ...
    },
    {
      ...
      description:
        "As software systems evolve from monoliths into distributed, cloud-native architectures, \
    ...
    },
    {
      ...
      description:
        "My journey into software hasn’t been a straight line. It didn’t start with childhood coding competitions, \
      ...
      <div className={styles.writingContent}>
        <div className={styles.writingHeader}>
          ...
          <p className={styles.subtitle}>
            Technical essays on software engineering, backend systems, cloud
            infrastructure, and the design decisions behind the projects I
            build. My writing focuses on clarity, trade-offs, and practical
            learning rather than tutorials or trend-driven content.
          </p>
        </div>
        ...
        <div className={styles.newsletterSection}>
          <div className={styles.newsletterContent}>
            ...
            <p>
              Get new articles on frontend, backend systems, cloud
              infrastructure, and software architecture delivered directly to
              your inbox.
            </p>
            <a
